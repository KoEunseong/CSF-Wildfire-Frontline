...
def run_inference():
    ...
    for idx, img_name in enumerate(image_files, 1):
        ...
        heat_t = torch.from_numpy(heat_in).unsqueeze(0).unsqueeze(0).float().to(DEVICE)  # (1,1,H,W)
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Inference with CLIP-Heat In4 SegFormer (4ch direct)")
